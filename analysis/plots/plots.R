...
C1V2 <- read.csv("~/HIV_latency_general/analysis/plots/C1V2_LS")
nef <- read.csv("~/HIV_latency_general/analysis/plots/nef_LS")
p17 <- read.csv("~/HIV_latency_general/analysis/plots/p17_LS")
tat <- read.csv("~/HIV_latency_general/analysis/plots/tat_LS")

C1V2ML <- read.csv("~/HIV_latency_general/analysis/plots/C1V2_ML")
nefML <- read.csv("~/HIV_latency_general/analysis/plots/nef_ML")
p17ML <- read.csv("~/HIV_latency_general/analysis/plots/p17_ML")
tatML <- read.csv("~/HIV_latency_general/analysis/plots/tat_ML")

C1V2LR<- read.csv("~/HIV_latency_general/analysis/plots/C1V2_LR")
nefLR <- read.csv("~/HIV_latency_general/analysis/plots/nef_LR")
p17LR <- read.csv("~/HIV_latency_general/analysis/plots/p17_LR")
tatLR <- read.csv("~/HIV_latency_general/analysis/plots/tat_LR")

C1V2Bayes<- read.csv("~/HIV_latency_general/analysis/plots/C1V2_Bayes")
nefBayes <- read.csv("~/HIV_latency_general/analysis/plots/nef_Bayes")
p17Bayes <- read.csv("~/HIV_latency_general/analysis/plots/p17_Bayes")
tatBayes <- read.csv("~/HIV_latency_general/analysis/plots/tat_Bayes")
combineBayes <- read.csv("~/HIV_latency_general/analysis/plots/combine_Bayes")
combineBayes2 <- read.csv("~/HIV_latency_general/analysis/plots/combine_Bayes2")
