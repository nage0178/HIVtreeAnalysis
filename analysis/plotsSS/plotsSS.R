...
library(viridis)
library(cowplot)
C1V2 <- read.csv("~/HIV_latency_general/analysis/plotsSS/C1V2_LS")
nef <- read.csv("~/HIV_latency_general/analysis/plotsSS/nef_LS")
p17 <- read.csv("~/HIV_latency_general/analysis/plotsSS/p17_LS")
tat <- read.csv("~/HIV_latency_general/analysis/plotsSS/tat_LS")

C1V2_LR <- read.csv("~/HIV_latency_general/analysis/plotsSS/C1V2_LR")
nef_LR <- read.csv("~/HIV_latency_general/analysis/plotsSS/nef_LR")
p17_LR <- read.csv("~/HIV_latency_general/analysis/plotsSS/p17_LR")
tat_LR <- read.csv("~/HIV_latency_general/analysis/plotsSS/tat_LR")

C1V2_ML <- read.csv("~/HIV_latency_general/analysis/plotsSS/C1V2_ML")
nef_ML <- read.csv("~/HIV_latency_general/analysis/plotsSS/nef_ML")
p17_ML <- read.csv("~/HIV_latency_general/analysis/plotsSS/p17_ML")
tat_ML <- read.csv("~/HIV_latency_general/analysis/plotsSS/tat_ML")

p17_Bayes <- read.csv("~/HIV_latency_general/analysis/plotsSS/p17_Bayes")
p17BayesSS10 <- read.csv("~/HIV_latency_general/analysis/plots/p17_Bayes")
